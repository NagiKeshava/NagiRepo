...
public class UserDAOImpl implements UserDAO {
	...
	public boolean save(User user) {
		try{
			...
			//if any excpetion comes during execute of try block, catch will execute
			e.printStackTrace();
			return false;
		}
	...
	public boolean update(User user) {try{
	...
	public User get(String id) {
		...
		//get method get the data from user table based on primay key i.e id
